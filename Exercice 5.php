...
<html>
    <head>
        <title>Atelier 2 | Exercice 5</title>
        <meta charset="UTF-8">
    ...
    <body class="bg-info-subtle text-primary">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-primary active" href="Exercice 5.php"><strong>Exercice 5</strong></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container my-3">
            <?php
                $ch="eSPERANCE sPORTIVE tUNIS";
                echo "<strong>En entrée :</strong> $ch<br>";
                $ch2="";
                for ($i=0; $i<strlen($ch); $i++)
                {
                    if ($ch[$i]==strtoupper($ch[$i]))
                        $ch[$i]=strtolower($ch[$i]);
                    $ch=ucwords($ch);
                    if ($ch[$i]==strtoupper($ch[$i]) && $ch[$i]!=" ")
                        $ch2.=$ch[$i];
                }
                echo "<strong>Affichage :</strong> $ch2";
            ?>
        </div>
    </body>
</html>