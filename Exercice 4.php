...
<html>
    <head>
        <title>Atelier 2 | Exercice 4</title>
        <meta charset="UTF-8">
    ...
    <body class="bg-info-subtle text-primary">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-primary active" href="Exercice 4.php"><strong>Exercice 4</strong></a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container my-3">
            <?php
                //1
                $ch="Amine Kilani";
                echo "<strong>Chaîne :</strong> ".$ch;
                //2
                echo "<br><strong>Longueur de la chaîne :</strong> ".strlen($ch);
                //3
                echo "<br><strong>Sous-chaîne :</strong> ".substr($ch,0,5);
                //4
                $ch2="";
                ...
                echo "<br><strong>Chaîne inversée :</strong> ".$ch2;
            ?>
        </div>
    </body>
</html>